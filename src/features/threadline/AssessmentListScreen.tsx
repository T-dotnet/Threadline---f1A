      ...
      {!hideNavigation && (
        <WorkspaceHeader 
          ...
          alerts={
            <>
              {conflicts.length > 0 && (
                <div className="px-[8px] py-[2px] rounded border border-red-500 text-red-500 text-[14px] font-bold uppercase whitespace-nowrap flex items-center gap-1.5">
                  <AlertTriangle size={14} />
                  {conflicts.length} Conflict{conflicts.length !== 1 ? 's' : ''}
                </div>
              )}
              {missingDocuments.length > 0 && (
                <div className="px-[8px] py-[2px] rounded border border-blue-500 text-blue-500 text-[14px] font-bold uppercase whitespace-nowrap flex items-center gap-1.5">
                  <FileText size={14} />
            ...
            {activeTab === "Documents" && (
              selectedDocumentLocal ? (
                <DocumentDetailsScreen 
                  document={selectedDocumentLocal} 
